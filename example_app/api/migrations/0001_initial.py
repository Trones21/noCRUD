# Generated by Django 3.2 on 2025-04-22 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('film', 'Film'), ('show', 'TV Show')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('production', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='characters', to='api.production')),
            ],
            options={
                'db_table': 'character',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pitches', to='api.character')),
